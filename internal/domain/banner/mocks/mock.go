...
import (
	...
	banner "github.com/CyberPiess/banner_sevice/internal/infrastructure/postgres/banner"
	redis_cache "github.com/CyberPiess/banner_sevice/internal/infrastructure/redis/cache"
...
func (m *MockbannerStorage) DeleteBanner(deleteBannerParams banner.BannerPutPostCriteria) error {
	m.ctrl.T.Helper()
...
func (m *MockbannerStorage) Get(bannerParams banner.GetUserBannerCriteria) ([]banner.BannerEntitySql, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", bannerParams)
	ret0, _ := ret[0].([]banner.BannerEntitySql)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockbannerStorage) GetAllBanners(bannerParams banner.GetBannersListCriteria) ([]banner.BannerEntitySql, error) {
	m.ctrl.T.Helper()
...
func (m *MockbannerStorage) PostBanner(postBannerParams banner.BannerPutPostCriteria) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockbannerStorage) PutBanner(putBannerParams banner.BannerPutPostCriteria) error {
	m.ctrl.T.Helper()
...
// DeleteFromCache mocks base method.
func (m *MockredisCache) DeleteFromCache(key string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteFromCache", key)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteFromCache indicates an expected call of DeleteFromCache.
func (mr *MockredisCacheMockRecorder) DeleteFromCache(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteFromCache", reflect.TypeOf((*MockredisCache)(nil).DeleteFromCache), key)
}
