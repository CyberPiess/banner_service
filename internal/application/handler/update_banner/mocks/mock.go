...
// Source: update_banner.go

// Package mock_update_banner is a generated GoMock package.
package mock_update_banner
...
func (m *MockputBannerService) DeleteBanner(newPutBanner banner_service.BannerEntity, user banner_service.User) (bool, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockputBannerService) PostBanner(newPostBanner banner_service.BannerEntity, user banner_service.User) (int, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockputBannerService) PutBanner(newPutBanner banner_service.BannerEntity, user banner_service.User) (bool, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockputBannerService) SearchAllBanners(bannerFilter banner_service.GetAllFilter, user banner_service.User) ([]banner_service.BannerEntity, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockputBannerService) SearchBanner(bannerFilter banner_service.GetFilter, user banner_service.User) (banner_service.BannerEntity, bool, error) {
	m.ctrl.T.Helper()
